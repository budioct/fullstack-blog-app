...
import dev.budioct.blog.mappers.PostMapper;
...
public class PostController {
    ...
    public ResponseEntity<List<PostDto>> getDrafts(@RequestAttribute UUID userId) {
        ...
        List<PostDto> postDtos = draftPosts.stream().map(post -> postMapper.toDto(post)).collect(Collectors.toList());
        return ResponseEntity.ok(postDtos);
    }
    ...
    public ResponseEntity<PostDto> createPost(
        ...
        PostDto createdDto = postMapper.toDto(post);
    ...
    public ResponseEntity<PostDto> updatePost(
        ...
        PostDto updatedPostDto = postMapper.toDto(post);
